module.exports.flights = 'YOUR_KEY_HERE';  //Google QPX API - Skyscanner Flight Search
...
module.exports.geolocationAPI = 'YOUR_KEY_HERE';  //Google Geo Coding API - Radar Geo Coding API
